...
#merge based on month 
  ...
  add_lines(x =as.Date("2020-03-01"),type = 'scatter', mode = 'lines',
            line = list(dash="dot", color = 'red', widthh=0.5, alpha = 0.5),name = 'First laboratory confirmed COVID-19 in NYC on 3/1')
#graph for bus
#pivoting
plot_bus = 
  mta_data %>%
...
```
#source for the first confirmed case:
